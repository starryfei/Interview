...
public class SingleTon {
	...
	/*
	 * private static SingleTon instance = null; 私有构造方法，防止被实例化 private
	 * SingleTon() { }
	 */
	// 1、懒汉式，线程不安全
	/*
	...
	/*
	 * 静态工程方法，创建实例 public static SingleTon getInstance() { if(instance == null)
	 * { synchronized (instance) { if(instance == null) instance = new
	 ...
	 * 
	 * // 让构造函数为 private，这样该类就不会被实例化 private SingleTon() { }
	 * 
	 * // 获取唯一可用的对象 public static SingleTon getInstance() { return instance; }
	 */
